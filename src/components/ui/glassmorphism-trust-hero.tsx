    ...
    <section className="relative h-dvh w-full overflow-hidden bg-black">
      ...
      <div className="absolute bottom-10 left-0 right-0 z-30 flex flex-col items-center text-center sm:bottom-12 lg:bottom-14">
        <p
          ...
          style={{ fontSize: "clamp(3rem, 5vw, 4rem)", WebkitTextStroke: "1px black" }}
        >
          Eunice Leow
        </p>
        <p className="mt-2 inline-block bg-white px-3 py-1 text-[9px] font-medium uppercase tracking-[0.25em] text-zinc-900 sm:text-[11px]">
          Computer Engineer
        </p>
      </div>
